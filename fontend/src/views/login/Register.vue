<template>
    <div :class="`container ${isdark ? 'container-night' : 'container-day'}`">
        <div :class="`box ${isdark ? 'box-night' : 'box-day'}`">
            ...
            <h1 style="color: rgb(0, 127, 255); margin: 100px 0 150px 0; font-size: 50px;"><i><b>Register</b></i></h1>
            <label id="usename"><span style="color:rgb(134,144,154)">username:</span><input v-model.lazy="name" type="text"></label>
            <label id="email"><span style="color:rgb(134,144,154) ;margin-left: 60px;">email:</span><input v-model.lazy="email" type="email"></label>
            <label id="password"><span style="color:rgb(134,144,154)">password:</span><input v-model.lazy="password" type="password"></label>
            <el-button @click="registion()" :class="`button ${isdark ? 'button-night' : 'button-day'}`" style="margin-top: 20px;" size="large" round>Registe</el-button>
